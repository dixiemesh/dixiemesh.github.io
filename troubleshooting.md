...
A huge help when diagnosing anything is the **[Dixie Mesh Analyzer](https://mesh.bnanzarc.com/#/home)**.
You can:

- **Find your node** — type your node name into the
  [Analyzer home](https://mesh.bnanzarc.com/#/home) to see if (and how) the
  network is hearing you.
- **Inspect packets** — watch live traffic on the
  [packets view](https://mesh.bnanzarc.com/#/packets?timeWindow=360) to see what's
  actually making it onto the mesh.
- **Check the live map** — see active nodes and coverage on the
  [live map](https://mesh.bnanzarc.com/#/live).
...
1. **Look yourself up in the Analyzer.** Search your node name on the
   [Analyzer](https://mesh.bnanzarc.com/#/home). If the network isn't seeing your
...
2. Treat it as a link problem: check the
   [live map](https://mesh.bnanzarc.com/#/live) to see whether any repeater is
...
- Aim for a **stable path to one repeater** rather than barely reaching a distant
  one.
- Use the [packets view](https://mesh.bnanzarc.com/#/packets?timeWindow=360) to
...
- Confirm in the [Analyzer](https://mesh.bnanzarc.com/#/home) that your own
